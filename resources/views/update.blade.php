        ...
        <div class="detail-box">
            <div class="container">
                <div class="card" style="background:rgba(255, 255, 255, 0.0);">
                  <form action="/product/{{$product->id}}/updated" method="post" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="pl-4 mt-3 mb-3"><h6><i class="bi bi-journal-plus"></i> Edit Product</h6></div>
                    <div class="d-flex">
                        <label for="name" class="form-lebel p-3 col-3">Name</label>
                        <input type="text" name="name" class="form-control p-3 col-8" id="name" value="{{old('name',$product->product_name)}}" >
                    </div>
                    <div class="d-flex">
                        <label for="model" class="form-lebel p-3 col-3">Model</label>
                        <input type="text" name="model" class="form-control p-3 col-8" id="model" value="{{old('model',$product->product_model)}}">
                    </div>
                    <div class="d-flex">
                        <label for="price" class="form-lebel p-3 col-3">Price</label>
                        <input type="text" name="price" class="form-control p-3 col-8" id="price" value="{{old('price',$product->product_price)}}">
                    </div>
                    <div class="d-flex">
                      <label for="quantity" class="form-lebel p-3 col-3">Quantity</label>
                      <input type="text" name="quantity" class="form-control p-3 col-8" id="quantity" value="{{old('quantity',$product->product_quantity)}}">
                  </div>
                    <div class="d-flex">
                        <label for="des" class="form-lebel p-3 col-3">Descreption</label>
                        <input type="text" name="des" class="form-control p-3 col-8" id="des" value="{{old('des',$product->product_des)}}">
                    </div>
                    <div class="d-flex">
